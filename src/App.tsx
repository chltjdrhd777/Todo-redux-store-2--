...
function App<_InitialStateType>({ state, dispatch }: any) {
  const { isEditing } = state.boolAlternate;
  const [appState, setState] = useState({ boolAlternate: false });
  const { boolAlternate } = appState;
